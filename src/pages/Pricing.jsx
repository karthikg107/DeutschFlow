import { Bot, Mic, TrendingUp, Star } from "lucide-react";
      ...
      <div className="pricing-page">
        ...
        <section className="pricing-grid">
          ...
          <div className="plan-card premium-card">
            ...
            >
              {currentPlan === "PREMIUM" ? "Current Plan" : "Upgrade Soon"}
            </button>
          </div>
        ...
        <p className="pricing-currency-note">
          Prices shown in EUR (€). Equivalent in other currencies: approx. $3.30 USD · £2.60 GBP ·
          ₹280 INR · ¥480 JPY. Exact amount charged depends on your payment provider's exchange
        ...
        <section className="benefits-section">
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              <div className="pricing-feature-icon"><Bot size={20} /></div>
            ...
            <div className="benefit-card">
              <div className="pricing-feature-icon"><Mic size={20} /></div>
            ...
            <div className="benefit-card">
              <div className="pricing-feature-icon"><TrendingUp size={20} /></div>
            ...
            <div className="benefit-card">
              <div className="pricing-feature-icon"><Star size={20} /></div>
